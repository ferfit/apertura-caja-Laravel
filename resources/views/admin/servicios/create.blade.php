...
@section('content')
    <div class="container">
        <div class="card">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form method="POST" id="formulario" action="{{ route('servicios.store') }}" novalidate>
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" min="0" name="precio"
                            class="form-control @error('precio') is-invalid @enderror" id="precio" value="">
                        @error('precio')
                            <span class="invalid-feedback d-block" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('servicios.index') }}" class="ml-1 btn btn-secondary"> <i
