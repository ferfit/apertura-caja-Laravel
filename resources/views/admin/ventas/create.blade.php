    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="new_property_form">
                <form method="POST" action="{{ route('ventas.store') }}" class="contact_form" novalidate>
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="ui_kit_select_search add_new_property mb20">
                                ...
                                <input autofocus name="titulo" class="form-control form_control @error('titulo') is-invalid @enderror"
                                    type="text" placeholder="" value="{{ old('titulo') }}">
